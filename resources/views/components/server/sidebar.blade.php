<div class="sub-menu-wrapper">
    ...
    @if ($server->isFunctional())
        ...
        <a class="sub-menu-item {{ $activeMenu === 'env-vars' ? 'menu-item-active' : '' }}" {{ wireNavigate() }}
            href="{{ route('server.env-vars', ['server_uuid' => $server->uuid]) }}"><span class="menu-item-label">Environment Variables</span>
        </a>
    @endif
